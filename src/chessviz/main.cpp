...
int main()
{
    string pawnb, knightb, bishopb, rookb, queenb, kingb, empty, pawnw, knightw, bishopw, rookw, queenw, kingw;
    char** chessGrid = new char*[board_size];
    for (int i = 0; i < board_size; i++) chessGrid[i] = new char[2 * board_size];
    pawnb = "Pb", knightb = "Nb", bishopb = "Bb", rookb = "Rb", queenb = "Qb", kingb = "Kb", empty = "  ";
    pawnw = "Pw", knightw = "Nw", bishopw = "Bw", rookw = "Rw", queenw = "Qw", kingw = "Kw";
